...
{
	U8 check= 0;
	if(	TC0_IS_TRUE_T0MODE(tmr0->Mode,tmr0->OC0PinMode,tmr0->Prescale,tmr0->DesiredINT,tmr0->CompVal,tmr0->TimerStartVal) )
	{
		check= 1;
		...
		*/
		...
		if( TC0_OC0_PWM(tmr0->Mode,tmr0->OC0PinMode) )  // if it PWM mode 
