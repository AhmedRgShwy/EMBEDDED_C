...
#define TC2_IS_TRUE(mode,OC2,clk,INT,comp,TC2val,syncSel)	( TC2_TRUE_OC2(mode,OC2)&&TC2_TRUE_CLK(clk)&&\
															TC2_TRUE_INT(INT)&&TC2_TRUE_SYNC_MODE(syncSel) )
...
#define TC2_StopTimer2()				TCCR2 |= TC2_DISABLE_CLK
#define TC2_READ_TC2VALUE				TCNT2&0xFF
